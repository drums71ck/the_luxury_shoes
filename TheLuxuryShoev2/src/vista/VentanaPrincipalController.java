...
public class VentanaPrincipalController  {
	...
	void btnBasketClicked(ActionEvent event) {
		...
		Image newImage = new Image("/vista/assets/AirJordan36.jpg",120,100, false, false);
		Image newImage2 = new Image("/vista/assets/rebound2.jpg",120,100, false, false);
		Image newImage3 = new Image("/vista/assets/zoomSeparate.jpg",120,100, false, false);
		Image newImage4 = new Image("/vista/assets/zoomFreak3.jpg",120,100, false, false);
		Image newImage5 = new Image("/vista/assets/jordanAirmid.jpg",120,100, false, false);
		...
		txtimg1.setText("Air Jordan 36");
		txtimg2.setText("Rebound 2");
		txtimg3.setText("Zoom Separate");
		txtimg4.setText("Zoom Freak 3");
		txtimg5.setText("Jordan Air Mid");
	...
	void btnFootballClicked(ActionEvent event) {
		Image newImage = new Image("/vista/assets/total90.jpg",120,100, false, false);
		Image newImage2 = new Image("/vista/assets/xinghuanhua.jpg",120,100, false, false);
		Image newImage3 = new Image("/vista/assets/ghosted_rosa.jpg",120,100, false, false);
		Image newImage4 = new Image("/vista/assets/futurez.jpg",120,100, false, false);
		Image newImage5 = new Image("/vista/assets/copaSense.jpg",120,100, false, false);
		foto1.setImage(newImage);
		foto11.setImage(newImage2);
		foto111.setImage(newImage3);
		foto1111.setImage(newImage4);
		...
		txtimg1.setText("Total 90");
		txtimg2.setText("Xinghuanhua");
		txtimg3.setText("Ghosted Rosa");
		txtimg4.setText("Futurez");
		txtimg5.setText("Copa Sense");
	}
	...
	void btnInFootballClicked(ActionEvent event) {
		...
		Image newImage = new Image("/vista/assets/grescaMunich.jpg",120,100, false, false);
		Image newImage2 = new Image("/vista/assets/sambaAdidas.jpg",120,100, false, false);
		Image newImage3 = new Image("/vista/assets/imviso100.jpg",120,100, false, false);
		Image newImage4 = new Image("/vista/assets/ViraltoII.jpg",120,100, false, false);
		Image newImage5 = new Image("/vista/assets/imvisoEskudo500.jpg",120,100, false, false);
		foto1.setImage(newImage);
		foto11.setImage(newImage2);
		foto111.setImage(newImage3);
		foto1111.setImage(newImage4);
		...
		txtimg1.setText("Gresca Munich");
		txtimg2.setText("Samba Adidas");
		txtimg3.setText("Imviso 100");
		txtimg4.setText("Viralto II");
		txtimg5.setText("Imviso Eskudo 500");
	}
	

	@FXML
	void btnVolley(ActionEvent event) {
		Image newImage = new Image("/vista/assets/adidasNovaflight.jpg",120,100, false, false);
		Image newImage2 = new Image("/vista/assets/allsix100.jpg",120,100, false, false);
		Image newImage3 = new Image("/vista/assets/asicsSkyElite.jpg",120,100, false, false);
		Image newImage4 = new Image("/vista/assets/asicsLightinhz6.jpg",120,100, false, false);
		Image newImage5 = new Image("/vista/assets/allsixV500.jpg",120,100, false, false);
		foto1.setImage(newImage);
		foto11.setImage(newImage2);
		foto111.setImage(newImage3);
		foto1111.setImage(newImage4);
		...
		txtimg1.setText("Adidas Nova Flight");
		txtimg2.setText("Allsix 100");
		txtimg3.setText("Asics Sky Elite");
		txtimg4.setText("Asics Lightinh Z6");
		txtimg5.setText("Allsix V500");
	...
	void tVentanaPrincipalController(ActionEvent event) {
	 ...
	 @FXML
	    void btnImage1unclicket(MouseEvent event) throws IOException {
		 ...
		 FileWriter escritura = new FileWriter("C:\\Users\\Drumstick\\eclipse-workspace\\TheLuxuryShoev2\\src\\vista\\ids.txt");
